...
## Project setup
Maven project using Spring Boot framework (Java). Application acts as REST controller accepting HTTP GET requests containing equation to render and associated settings. Returns an image file.
